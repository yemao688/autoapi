...
export function ChangeMasterPassword(arg1, arg2) {
  return window['go']['api']['App']['ChangeMasterPassword'](arg1, arg2);
}
...
export function HasMasterPassword() {
  return window['go']['api']['App']['HasMasterPassword']();
}

export function IsUnlocked() {
  return window['go']['api']['App']['IsUnlocked']();
}
...
export function SetMasterPassword(arg1) {
  return window['go']['api']['App']['SetMasterPassword'](arg1);
}
...
export function Unlock(arg1) {
  return window['go']['api']['App']['Unlock'](arg1);
}
